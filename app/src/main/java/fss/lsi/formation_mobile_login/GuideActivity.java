...
public class GuideActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Hooks
        menuIcon = findViewById(R.id.menu_icon_guide);
        contentView = findViewById(R.id.content_guide);

        //Menu Hooks
        drawerLayout = findViewById(R.id.drawable_layout_guide);
        navigationView = findViewById(R.id.navigation_view_guide);
    ...
    private void navigationDrawer() {
        ...
        navigationView.setCheckedItem(R.id.guide);
