...
public class dataHolderProblem {
    String champ1,champ2,champ3,champ4,champ5,email;
    public dataHolderProblem(String champ1, String champ2 , String champ3, String champ4, String champ5, String email){
        this.champ1=champ1;
        this.champ2=champ2;
        this.champ3=champ3;
        this.champ4=champ4;
